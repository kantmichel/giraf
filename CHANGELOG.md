...
* **dashboard:** commit velocity chart with squash-merge handling ([f547c70](https://github.com/kantmichel/giraf/commit/f547c7006c255562f3200834748e59380a76d279))
...
* **filters:** match requested PR reviewers in the assignee filter ([40d6d28](https://github.com/kantmichel/giraf/commit/40d6d282b08d6cbedf8f19891034fa642579a9fe))
...
* **issues:** filter and sort by creation date, age badge on cards ([1eb8d68](https://github.com/kantmichel/giraf/commit/1eb8d6813c670b1e9ee8ccd1fa670e05c4c36278))
...
* **wsjf:** weight critical priority so it always outranks lower tiers ([948d1bd](https://github.com/kantmichel/giraf/commit/948d1bd359ac4445f2d6d0dbfc2256f3ff2c9cf6))
...
* **auth:** configure GitHub issuer for RFC 9207 iss callback param ([30c78b4](https://github.com/kantmichel/giraf/commit/30c78b41d8b1669835094e6f5c1d3b817c050b0f))
* **auth:** take the public origin from the proxy when NEXTAUTH_URL is unset ([39074bd](https://github.com/kantmichel/giraf/commit/39074bdd49a069d674730b4e821be124ecf79b58))
...
* release 1.36.0 ([e44b8bb](https://github.com/kantmichel/giraf/commit/e44b8bb3c8f547278113b6e8d39e2883e407df51))
